      ...
      <div className="max-w-6xl mx-auto relative md:h-[1350px]">
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          ...
          <TagCard
            number="01"
            title="Data Analysis"
            text="Designing Streamlit dashboards to monitor 20+ KPIs, performing KPI analysis, and managing operational data records for actionable insights."
          ...
          <TagCard
            ...
            text="Building end-to-end AI pipelines using XGBoost with temporal and weather features for demand forecasting and supply optimization."
          ...
          <TagCard
            ...
            text="Developing FastAPI-based backends for structured data ingestion and designing normalized MySQL schemas for large-scale operational data."
          ...
          <TagCard
            ...
            text="Building automated 3-stage pipelines (CSV → GOLD Parquet → Forecast) and ensuring reliability with comprehensive pytest unit testing."
