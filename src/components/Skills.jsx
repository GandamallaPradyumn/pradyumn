  ...
  const skillsData = [
    {
      ...
      skills: ['XGBoost', 'Scikit-learn', 'Pandas', 'NumPy', 'Matplotlib', 'Predictive Analytics', 'Feature Engineering'],
    },
    {
      category: 'Backend & Database',
      skills: ['Python', 'SQL', 'FastAPI', 'REST APIs', 'MySQL', 'ETL Pipelines', 'Pytest'],
    },
    {
      category: 'Tools & Automation',
      skills: ['Streamlit', 'MS Excel', 'Jupyter Notebook', 'Data Cleaning', 'KPI Analysis', 'Automation'],
    },
    {
      category: 'General',
      skills: ['Git', 'GitHub', 'DSA', 'DBMS', 'Statistics'],
    },
  ];
